...
INSERT INTO `users` (`id`,`name`,`gender`,`country`,`aboutYou`,`mailingList`) VALUES 
 (4,'uzzol','Male','Bangladesh','java programmer',1),
 (5,'akram','Male','Bangladesh','java programmer',1),
 (6,'zubayer','Male','Bangladesh','web developer',1);
